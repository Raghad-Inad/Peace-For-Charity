<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="volunteer.SignUp" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                           <h4><asp:Localize ID="Localize1" text="Sign Up" runat="server"></asp:Localize></h4>
                        </center>
                            </div>
                        </div>
                        <div class="row">
      ...
      <img src="assets/img/generaluser.png" style="height:150px; width:150px;" alt="User Icon" />
                        ...
                        <div class="row">
                            <div class="col-md-8" style="margin-left: 17%">
                                <asp:Button ID="btnSignUp" class="btn btn-secondary btn-block" runat="server" Text="Sign Up" OnClick="btnSignUp_Click" />
                            </div>
                        </div>
                    </div>
                </div>
